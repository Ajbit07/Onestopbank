...
docker-compose Postgres. `jwt.secret` there must stay valid base64 decoding to at
least 64 bytes - `TokenServiceImpl` base64-decodes it and signs with HS512. To run
them locally:
